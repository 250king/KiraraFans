...
object ConnectorHandler {
    ...
    fun startV2Ray(a: MainActivity) {
        ...
        HttpUtil.protectedApi("https://hk.api.kirafan.xyz").initProxy().enqueue(object : Callback<ResponseBody> {
    ...
    fun stopV2rayPoint() {
        ...
        HttpUtil.protectedApi("https://hk.api.kirafan.xyz").revokeProxy().enqueue(object : Callback<Unit> {
